...
def fix_file(filepath):
    ...
    # The page-viewer block has this structure:
    # <!-- Page Image Viewer ... -->
    # <div class="page-viewer" ...>
    #     <div class="page-viewer-header">...</div>
    #     <div class="page-viewer-main">...</div>
    #     <div class="page-viewer-thumbnails" ...></div>
    # </div>
    
    # Remove ALL page viewer blocks - match from comment to closing div
    # The outer div only has 3 child divs, so we need 1 closing </div> for the outer
    pattern = r'\s*<!-- Page Image Viewer \(populated by JS if images exist\) -->\s*<div class="page-viewer"[^>]*>.*?<div class="page-viewer-thumbnails"[^>]*></div>\s*</div>'
